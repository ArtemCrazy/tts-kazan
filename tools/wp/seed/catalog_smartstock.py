...
def blocks():
    ...
    return [
        ...
        },
        {
            ...
            'anchor': 'asu',
            'fields': {
                'tts_figures_kicker': 'Основные преимущества',
                'tts_figures_title': 'Терминал как управляемая система',
                'tts_figures_lead': 'Проектирование охватывает технологию, бизнес-логику потоков, '
                                    'обслуживание и интеграцию с действующей площадкой.',
                'tts_figures_tone': 'dark',
                'tts_figures_items': [
                    {'tts_figures_item_value': '90',
                     'tts_figures_item_label': 'рабочих дней — средний срок выпуска'},
                    {'tts_figures_item_value': 'до 4',
                     'tts_figures_item_label': 'марок цемента в одном комплексе'},
                ],
            },
        },
        {
            'block': 'points',
            'fields': {
                'tts_points_kicker': 'Что даёт автоматизация',
                'tts_points_title': 'Управление и прозрачность',
                'tts_points_tone': 'dark',
                'tts_points_items': [
                    {'tts_points_item_title': 'Комплексная автоматизация',
                     'tts_points_item_text': 'Собственная АСУ управляет точкой входа — приямком, '
                                             'бункером и аспирацией — и точкой выхода: силосами, '
                                             'загрузчиком и автовесами.'},
                    {'tts_points_item_title': 'Прозрачность для владельца',
                     'tts_points_item_text': 'Остатки доступны в реальном времени по данным '
                                             'ж/д-весов, автовесов и расчётному уровню '
                                             'в силосах — без выезда на площадку.'},
                    {'tts_points_item_title': 'Сложные проекты',
                     'tts_points_item_text': 'Управление потоками разных марок, работа в сложных '
                                             'климатических условиях и реализация нестандартных '
                                             'схем дистрибуции.'},
                    {'tts_points_item_title': 'Удобство эксплуатации',
                     'tts_points_item_text': 'Площадки обслуживания загрузчиков, головки '
