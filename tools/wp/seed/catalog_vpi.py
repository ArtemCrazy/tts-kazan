...
* оговорка про расчётный характер экономических показателей (п. 16 ТЗ) лежит
  в лиде блока split и со страницы уходить не должна.
"""
...
def blocks():
    ...
    return [
        ...
        {
            # Тёмная секция #economy в статике — двухколоночный .split
            # (site/4/catalog/vpi/index.html): слева цифры экономики,
            # справа номенклатура изделий. Переносим одним блоком split.
            #
            ...
            'anchor': 'economy',
            'fields': {
                'tts_split_kicker': 'Экономика линии',
                'tts_split_title': 'Управляемая себестоимость и выход на плановую мощность',
                'tts_split_lead': 'Все показатели экономики являются расчётными ориентирами, '
                ...
                'tts_split_figures': [
                    {'tts_split_figure_value': '12–16',
                     'tts_split_figure_label': 'месяцев — ориентировочная окупаемость'},
                    {'tts_split_figure_value': 'до 15%',
                     'tts_split_figure_label': 'снижение расхода цемента'},
                    {'tts_split_figure_value': 'до 20%',
                     'tts_split_figure_label': 'снижение эксплуатационных затрат'},
                    {'tts_split_figure_value': '85–95%',
                     'tts_split_figure_label': 'целевая загрузка линии'},
                ],
                'tts_split_points_kicker': 'Номенклатура',
                'tts_split_points_title': 'Одна линия — широкая номенклатура ВПИ',
                'tts_split_points': [
                    {'tts_split_point_title': 'Тротуарная плитка',
                     'tts_split_point_text': 'Основная продукция линии при смене пресс-форм.'},
                    {'tts_split_point_title': 'Брусчатка',
                     'tts_split_point_text': 'Изделия повышенной прочности для проездов '
                                             'и площадок.'},
                    {'tts_split_point_title': 'Бордюрный камень',
                     'tts_split_point_text': 'Дорожные и садовые бордюры в составе одной линии.'},
                    {'tts_split_point_title': 'Стеновые блоки',
                     'tts_split_point_text': 'Стеновые изделия при соответствующей комплектации '
                                             'пресс-форм.'},
                ],
            },
        },
