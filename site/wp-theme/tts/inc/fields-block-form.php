		...
		array(
			...
			'fields'   => array(
				...
				array(
					...
					'name'         => 'tts_form_title',
					'type'         => 'textarea',
					'instructions' => 'Enter — перенос строки на компьютере. На телефоне строки переносятся сами.',
					'required'     => 1,
					'rows'         => 2,
					'new_lines'    => '',
				),
				...
				array(
					...
					'sub_fields'   => array(
						...
						array(
							'key'           => 'field_tts_form_direction_default',
							'label'         => 'Выбран по умолчанию',
							'name'          => 'tts_form_direction_default',
							'type'          => 'true_false',
							'instructions'  => 'С каким вариантом форма открывается. Если не отмечен ни один — с первым.',
							'ui'            => 1,
							'default_value' => 0,
						),
					),
				...
				array(
					...
					'sub_fields'   => array(
						...
						array(
							'key'           => 'field_tts_form_second_option_default',
							'label'         => 'Выбран по умолчанию',
							'name'          => 'tts_form_second_option_default',
							'type'          => 'true_false',
							'instructions'  => 'С каким вариантом форма открывается. Если не отмечен ни один — с первым.',
							'ui'            => 1,
							'default_value' => 0,
