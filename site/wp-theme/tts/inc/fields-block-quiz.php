	...
	acf_add_local_field_group(
		array(
			...
			'fields'   => array(
				...
				array(
					'key'           => 'field_tts_quiz_default_object',
					'label'         => 'Тип объекта по умолчанию',
					'name'          => 'tts_quiz_default_object',
					'type'          => 'select',
					'instructions'  => 'С каким ответом квиз открывается. Если такого типа нет в матрице подбора — с первым.',
					'choices'       => array(
				...
				array(
					...
					'sub_fields'   => array(
						...
						array(
							'key'           => 'field_tts_quiz_stage_default',
							'label'         => 'Выбрана по умолчанию',
							'name'          => 'tts_quiz_stage_default',
							'type'          => 'true_false',
							'instructions'  => 'Если не отмечена ни одна — первая.',
							'ui'            => 1,
							'default_value' => 0,
						),
					),
